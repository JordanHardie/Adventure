...
class LevelUpUI:
    def __init__(self, screen, font):
        ...
        self.stats = ["strength", "defence", "health", "speed", "stamina", 
                     "dexterity", "magic_power", "magic_defence", "wisdom", "intelligence"]
    ...
    def draw(self, current_stats):
        ...
        # Draw level up menu
        title = self.font.render(f"Level Up! Points: {self.points_available}", True, GameConfig.WHITE)
